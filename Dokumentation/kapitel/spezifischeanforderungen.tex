...
Alle Tasks in der Simulation hab selbe Priorität (200) und ändern diese nicht. Sie werden in einer festen Reihenfolge gespawned und laufen dann in jedem Zyklus in dieser Reihenfolge.
